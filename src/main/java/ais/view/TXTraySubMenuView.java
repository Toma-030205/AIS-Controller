...
public class TXTraySubMenuView extends JPanel {
    ...
    private void initComponents() {
        ...
        subHeaderLabel.setBorder(BorderFactory.createEmptyBorder(8, 12, 8, 12));
        ...
        menuList.setBorder(BorderFactory.createEmptyBorder(0, 0, 35, 0));
