...
public class CommunicationAckPopupView extends JPanel {
    ...
    public CommunicationAckPopupView() {
    ...
    /* ===== API ===== */
    public void setAckResult(boolean ok) {
        resultLabel.setText(ok ? "ACK : OK" : "ACK : NG");
    }
