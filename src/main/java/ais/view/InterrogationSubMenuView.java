...
public class InterrogationSubMenuView extends JPanel {
    ...
    private void initComponents() {
        ...
        /* ===== メインヘッダ ===== */
        JLabel header = new JLabel("INTERROGATION");
        ...
        subMenuListModel.addElement("[ CHECK ]");
        subMenuListModel.addElement("[ CLEAR ]");
